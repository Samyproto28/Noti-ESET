...
// Mensaje visual de sesión expirada
...
// Unificar actualización de UI por sesión
...
// Sobrescribir checkSession para usar la nueva función
async function checkSession() {
    await actualizarUIporSesion();
}

// Manejar expiración de JWT en llamadas protegidas
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Mostrar/ocultar formulario de publicar noticia según autenticación
    ...
    // No hay onAuthStateChange, así que escuchamos storage (por si hay cambios en otra pestaña)
    window.addEventListener('storage', checkSession);

    // Mostrar el formulario de login/registro al hacer click en el botón del header
    if (headerAuthBtn) {
    ...
    // Ocultar el contenedor de autenticación al iniciar sesión o cerrar sesión
    ...
    // Editar noticia (rellena el formulario y cambia el submit)
